#!/usr/bin/env python3
"""
Test file for Neuron class in 6-neuron.py
"""
...
def main():
    ...
    try:
        ...
        X = np.random.randn(nx, 5)
        Y = np.random.randint(0, 2, (1, 5))
        # Train the neuron using the train method
        prediction, cost = neuron.train(X, Y, iterations=1000, alpha=0.05)
        print("Predictions after training:", prediction)
